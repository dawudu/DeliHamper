...
public class HamperE extends AppCompatActivity {

    TextView txtHamperE, hamperE_price, packageE_description;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hamper_e);

        number_Button = (ElegantNumberButton) findViewById(R.id.number_button);
        btnCart = (FloatingActionButton) findViewById(R.id.btnCart);

        txtHamperE = (TextView) findViewById(R.id.txtHamperE);
        hamperE_price = (TextView) findViewById(R.id.hamperE_price);
        packageE_description = (TextView) findViewById(R.id.packageE_description);
        ...
        hamperItems = hamperDescriptions.getHamperE();
        packageE_description.setText(hamperItems);
    ...
    public void displayPackagePrice(double number) {
        ...
        hamperE_price = (TextView) findViewById(R.id.hamperE_price);
        hamperE_price.setText(String.valueOf(number));
