...
public class Register extends AppCompatActivity {
    ...
    private EditText inputEmail, inputPassword, Name, Lastname, Address, ContactNumber;
                        ...
                        .addOnCompleteListener(Register.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    profile.setPassword(inputPassword.getText().toString().trim());

                                   // db.child("Register").child(auth.getCurrentUser().getUid());


                                    profile.setName(Name.getText().toString());
                                    profile.setLastname(Lastname.getText().toString());
                                    profile.setAddress(Address.getText().toString());
                                    profile.setContactNumber(ContactNumber.getText().toString());

                                    db.child("Register").child(auth.getCurrentUser().getUid()).setValue(profile);


                                    Toast.makeText(Register.this, "Login Success!" + task.getException(),
